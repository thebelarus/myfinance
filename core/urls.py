...
urlpatterns = [
    ...
    path('delete/currency/<int:currency_id>/', views.delete_currency, name='delete_currency'),
    ...
    path('get/pdf/account/<int:account_id>/', views.account_to_pdf_export, name='account_to_pdf_export'),
    ...
    path('delete/expenses/category/<int:category_id>/', views.delete_expenses_category, name='delete_expenses_category'),       
    path('add/income/subcategory/', views.add_income_sub_category, name='add_income_sub_category'),
    path('delete/income/subcategory/<int:category_id>/', views.delete_income_sub_category, name='delete_income_sub_category'),
    path('add/expenses/subcategory/', views.add_expenses_sub_category, name='add_expenses_sub_category'),   
    path('delete/expenses/subcategory/<int:category_id>/', views.delete_expenses_sub_category, name='delete_expenses_sub_category'),   
    ...
    path('delete/expenses/<int:expenses_id>/',views.delete_expenses, name='delete_expenses'),
